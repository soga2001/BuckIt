...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/@nuxtjs/ionic/dist/runtime/plugins/router").default> &
  ...
  InjectionType<typeof import("../../node_modules/@nuxtjs/ionic/dist/runtime/plugins/ionic").default> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt-ionic:router' | 'supabase' | 'supabase' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | 'auth-redirect' | 'nuxt:checkIfLayoutUsed'
  }
}
